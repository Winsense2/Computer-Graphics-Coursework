...
int main(void)
{
    ...
    object.position = glm::vec3(0.0f, 4.0f, -8.0f);
        ...
        // Add wall model to objects vector
        object.position = glm::vec3(-8.0f, 4.0f, 0.0f);
        object.scale = glm::vec3(5.0f, 1.0f, 5.0f);
        ...
        // Load a 2D plane model for the ceiling and add textures
        Model ceiling("../assets/plane.obj");
        ceiling.addTexture("../assets/stones_diffuse.png", "diffuse");
        ...
        object.position = glm::vec3(0.0f, 10.0, 0.0f);
        object.scale = glm::vec3(1.0f, 1.0f, 1.0f);
        object.rotation = glm::vec3(1.0f, 0.0f, 0.0f);
        object.angle = glm::radians(180.0f);
        object.name = "ceiling";
        objects.push_back(object);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < static_cast<unsigned int>(objects.size()); i++)
        {
            ...
            if (objects[i].name == "wall 1")
                wall.draw(shaderID);

            if (objects[i].name == "wall 2")
                wall.draw(shaderID);

            if (objects[i].name == "wall 3")
                wall.draw(shaderID);

            if (objects[i].name == "wall 4")
                wall.draw(shaderID);
